...
if __name__ == "__main__":
    ...
    # -----------------------------------8-----------------------------------------------------------------------------------------#
    model_path = "model_data/best_deeplabv3plus_resnet101_voc_os16.pth"
    # ---------------------------------------------------------#
    ...
    #   读取数据集对应的txt
    # ---------------------------#
    with open(os.path.join(root_dataset_path, "VOC2007/ImageSets/Segmentation/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(root_dataset_path, "VOC2007/ImageSets/Segmentation/val.txt"),"r") as f:
